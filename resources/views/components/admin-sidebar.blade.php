<aside class="admin-sidebar">
    ...
    <div class="sidebar-user">
        ...
        <div class="user-info">
            <p class="user-name">{{ Auth::user()->name ?? 'Administrador' }}</p>
    ...
    <nav class="sidebar-nav">
        ...
        <!-- Carrito -->
        <a href="{{ route('carrito.index') }}" class="nav-link {{ request()->routeIs('carrito.*') ? 'active' : '' }}">
        ...
        <!-- Trabajos -->
        <a href="{{ route('trabajos.index') }}" class="nav-link {{ request()->routeIs('trabajos.*') ? 'active' : '' }}">
        ...
        <!-- Alquileres -->
        <a href="{{ route('alquileres.index') }}" class="nav-link {{ request()->routeIs('alquileres.*') ? 'active' : '' }}">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>
            Alquileres
        </a>

        <!-- Maquinarias -->
        <a href="{{ route('maquinarias.index') }}" class="nav-link {{ request()->routeIs('maquinarias.*') ? 'active' : '' }}">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z"/></svg>
            Maquinarias
        </a>

        <!-- Reportes IA -->
        <a href="{{ route('reportes-ia.index') }}" class="nav-link {{ request()->routeIs('reportes-ia.*') ? 'active' : '' }}">
        ...
        <!-- Devoluciones y Garantías (CU16) -->
        <a href="{{ route('admin.devoluciones.index') }}" class="nav-link {{ request()->routeIs('admin.devoluciones.*') ? 'active' : '' }}">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 14 4 9 9 4"></polyline><path d="M20 20v-7a4 4 0 0 0-4-4H4"></path></svg>
            Devoluciones
        </a>

        <!-- Mantenimiento de Maquinaria (CU21) -->
        <a href="{{ route('admin.mantenimientos.index') }}" class="nav-link {{ request()->routeIs('admin.mantenimientos.*') ? 'active' : '' }}">
        ...
        <!-- Pedidos de Reabastecimiento (CU19) -->
        ...
        <!-- Promociones y Combos (CU20) -->
        <a href="{{ route('admin.promociones.index') }}" class="nav-link {{ request()->routeIs('admin.promociones.*') ? 'active' : '' }}">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="19" y1="5" x2="5" y2="19"></line><circle cx="6.5" cy="6.5" r="2.5"></circle><circle cx="17.5" cy="17.5" r="2.5"></circle></svg>
            Promociones
        </a>
        @endcan
    </nav>
    ...
    <div class="sidebar-footer">
        <form method="POST" action="{{ route('logout') }}" style="margin-top: 0;">
            @csrf
            <button type="submit" class="nav-link logout-btn" style="width: 100%; text-align: left; background: none; border: none; cursor: pointer;">
